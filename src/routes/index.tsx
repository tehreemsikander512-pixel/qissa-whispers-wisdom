    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-2xl px-6 pt-16 pb-24 text-center">
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <Link to="/chat" className="rounded-full bg-primary px-10 py-4 text-lg font-medium text-primary-foreground shadow-sm transition hover:opacity-90">
            Start Talking
          </Link>
          <Link to="/wisdom" className="rounded-full border border-border px-8 py-4 text-lg font-medium text-foreground transition hover:bg-accent">
