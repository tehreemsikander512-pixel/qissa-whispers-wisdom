...
export const Route = createFileRoute("/signup")({
  ...
  head: () => ({
    meta: [
      { title: "Create an account — Qissa" },
      { name: "description", content: "Create your Qissa account." },
      { property: "og:title", content: "Create an account — Qissa" },
      { property: "og:description", content: "Create your Qissa account." },
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto flex max-w-md flex-col px-6 pt-8 pb-24">
        ...
        <p className="mt-3 text-center text-muted-foreground">Join Qissa in a moment.</p>
        ...
        <form onSubmit={handleEmail} className="space-y-4">
          ...
          {info && <p className="rounded-md bg-accent px-3 py-2 text-sm text-foreground">{info}</p>}
